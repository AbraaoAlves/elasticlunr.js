...
var SortedSet = /** @class */ (function () {
     ...
     * @memberOf SortedSet
     */
    SortedSet.load = function (serialisedData) {
        var set = new this;
     ...
     * @memberOf SortedSet
     */
    SortedSet.prototype.map = function (fn, ctx) {
     ...
     * for the function fn.
     */
    SortedSet.prototype.forEach = function (fn, ctx) {
     ...
     * @memberOf SortedSet
     */
    SortedSet.prototype.intersect = function (otherSet) {
        var intersectSet = new SortedSet, i = 0, j = 0, a_len = this.length, b_len = otherSet.length, a = this.elements, b = otherSet.elements;
        while (true) {
     ...
     * @memberOf SortedSet
     */
    SortedSet.prototype.union = function (otherSet) {
     ...
     * @memberOf SortedSet
     */
    SortedSet.prototype.toJSON = function () {
        return this.toArray();
    };
    return SortedSet;
}());
